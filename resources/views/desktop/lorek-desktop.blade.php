                    ...
                    <div class="panel-item flex items-center justify-center p-6 lg:p-12">
                        <div class="w-full max-w-md space-y-8">
                            ...
                            <div class="mt-8">
                                ...
                                <div class="space-y-3">
                                    <a href="/auth/google" class="flex items-center justify-center gap-3 py-4 bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 rounded-xl font-semibold text-gray-700 transition-all duration-300 w-full hover:shadow-md">
