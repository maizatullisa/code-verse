                        ...
                        <div class="flex-1">
                            ...
                            <div class="mb-2">
                                <div class="flex justify-between items-center mb-1">
                                    ...
                                    <span class="text-xs text-p2 font-semibold">65%</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-p2 h-2 rounded-full transition-all" style="width: 65%"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mb-2">
                                <div class="flex justify-between items-center mb-1">
                                    <span class="text-xs text-gray-600">Progress</span>
                                    <span class="text-xs text-p2 font-semibold">15%</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-p2 h-2 rounded-full transition-all" style="width: 15%"></div>
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-col gap-2">
