        ...
        <div class="max-w-6xl mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <a href="{{ url('/roadmap') }}" class="text-gray-500 hover:text-gray-700 transition-colors">
    ...
    <main class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="mt-12 grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <p class="text-gray-600">{{ $roadmap['prerequisite'] }}</p>
                <div class="mt-4 text-sm text-gray-500">
                    <div>Estimated Time: <span class="font-medium text-gray-700">{{ $roadmap['duration'] }}</span></div>
                    <div>Difficulty Level: <span class="font-medium text-gray-700">{{ $roadmap['level'] }}</span></div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <p class="text-gray-600 mb-3">Average salary range in Indonesia</p>
                <div class="text-2xl font-bold text-green-600">{{ $roadmap['career_salary'] }}</div>
                <div class="mt-3 text-sm text-gray-500">
                    Based on current market data from various job portals
                </div>
            </div>
        </div>
    </main>
