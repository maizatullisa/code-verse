...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-3xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-12 h-12 bg-purple-600 rounded-2xl flex items-center justify-center shadow-md">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white p-6 rounded-3xl shadow-md border border-gray-200">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="w-8 h-8 bg-indigo-600 rounded-2xl flex items-center justify-center shadow-md">
            ...
            <div class="bg-white p-6 rounded-3xl shadow-md border border-gray-200">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="w-8 h-8 bg-green-600 rounded-2xl flex items-center justify-center shadow-md">
                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
