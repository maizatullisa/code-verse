...
<head>
    ...
    <title>Quiz 5 - Quizio PWA HTML Template</title>
      ...
      <div class="relative z-20 px-6">
        <div class="flex justify-between items-center gap-5">
          ...
          >
            ...
            <p class="text-xs font-semibold text-nowrap">5 of 10</p>
          </div>
        ...
        >
          ...
          <div class="pt-8">
            <img src="assets/images/quiz-5-img.png" alt="" class=" rounded-xl">
          </div>
        ...
        <div class="flex flex-col gap-4 pt-8">
          ...
          >
            <p class="text-p3 text-sm font-semibold">This</p>
            <div
          ...
          >
          <p class=" text-sm font-semibold">is</p>
          <div
  ...
  >
  <p class="text-p1 text-sm font-semibold">calendar</p>
  <div
