        ...
        <nav class="flex-1 space-y-2">
            @php
                function activeSidebar($routeName) {
                    return request()->routeIs($routeName) ? 'bg-white/80 border border-blue-200 text-gray-900 font-semibold' : 'text-gray-700 hover:bg-white/60';
                }
            @endphp

            <a href="{{ route('admin.dashboard') }}" class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 hover-lift cursor-pointer {{ activeSidebar('admin.dashboard') }}">
                ...
                <span class="font-medium group-hover:text-gray-900">Dashboard</span>
            </a>

            <a href="{{ route('admin.user.index') }}" class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 hover-lift cursor-pointer {{ activeSidebar('admin.user.index') }}">
                ...
                <span class="font-medium group-hover:text-gray-900">Users</span>
            </a>

            <a href="{{ route('admin.pengajar.index') }}" class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 hover-lift cursor-pointer {{ activeSidebar('admin.pengajar.index') }}">
                ...
                <span class="font-medium group-hover:text-gray-900">Pengajar</span>
            </a>

            <a href="{{ route('admin.kelas.index') }}" class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 hover-lift cursor-pointer {{ activeSidebar('admin.kelas.index') }}">
                ...
                <span class="font-medium group-hover:text-gray-900">Kelas</span>
            </a>

            <a href="{{ route('admin.quiz.index') }}" class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 hover-lift cursor-pointer {{ activeSidebar('admin.quiz.index') }}">
                ...
                <span class="font-medium group-hover:text-gray-900">Quiz</span>
            </a>

            <a href="{{ route('admin.sertifikat.index') }}" class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 hover-lift cursor-pointer {{ activeSidebar('admin.sertifikat.index') }}">
                ...
                <span class="font-medium group-hover:text-gray-900">Sertifikat</span>
            </a>

             <a href="{{ route('/admin/roadmap') }}" class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 hover-lift cursor-pointer {{ activeSidebar('admin.sertifikat.index') }}">
                <div class="w-8 h-8 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-lg flex items-center justify-center ios-shadow group-hover:scale-110 transition-transform duration-300">
                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/>
                    </svg>
                </div>
                <span class="font-medium group-hover:text-gray-900">Roadmap</span>
            </a>
        </nav>
