...
<!-- Mirrored from softivuslab.com/html/quizio/live-demo/quiz-10.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 05:05:00 GMT -->
<head>
    <meta charset="UTF-8" />
    ...
    <title>Quiz 10 - Quizio PWA HTML Template</title>
      ...
      <div class="relative z-20 px-6">
        <div class="flex justify-between items-center gap-5">
          ...
          >
            ...
            <p class="text-xs font-semibold text-nowrap">10 of 10</p>
          </div>
        ...
        >
          ...
          <div class="h-24 w-24 rounded-full bg-p2 p-2 -mt-16">
            <div
              class="h-full progress w-full bg-white dark:bg-color9 rounded-full flex justify-center items-center text-lg font-bold p-1.5 relative"
            >
          ...
          <p class="text-2xl font-semibold pt-8">Question 10</p>
       
          <div class="mt-8 flex flex-col gap-4 justify-center items-center py-10 bg-color16 w-full rounded-xl border border-p2">
            
            <p class="text-sm font-semibold text-p2 max-w-[150px]">A for Apple, B for Ball, C for Cat </p>
           </div>
          ...
          >
          Spell the short sentence above!
          </p>
        </div>

        <div class="mt-8 flex flex-col gap-4 justify-center items-center py-10 bg-color16 w-full rounded-xl border border-p2">
          <div class="bg-p2 rounded-full p-5 flex justify-center items-center">
           <i class="ph-fill ph-microphone text-white text-2xl !leading-none "></i>
          </div>
          <p class="text-sm font-semibold text-p2 max-w-[300px] text-center">Press and hold to record, and release to submit an answer</p>
         </div>

      <div class="pt-12">
        <a
        href="result-summary.html"
...
<!-- Mirrored from softivuslab.com/html/quizio/live-demo/quiz-10.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 05:05:01 GMT -->
</html>
