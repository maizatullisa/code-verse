...
<!-- Mirrored from softivuslab.com/html/quizio/live-demo/quiz-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 05:04:59 GMT -->
<head>
    <meta charset="UTF-8" />
    ...
    <title>Quiz 7 - Quizio PWA HTML Template</title>
      ...
      <div class="relative z-20 px-6">
        <div class="flex justify-between items-center gap-5">
          ...
          >
            ...
            <p class="text-xs font-semibold text-nowrap">7 of 10</p>
          </div>
        ...
        >
          ...
          <p class="text-2xl font-semibold pt-8">Question 05</p>
          <div class="mt-8 flex flex-col gap-4 justify-center items-center py-10 bg-color16 w-full rounded-xl border border-p2">
           <div class="bg-p2 rounded-full p-5 flex justify-center items-center">
            <i class="ph-fill ph-play text-white text-2xl !leading-none "></i>
           </div>
           <p class="text-sm font-semibold text-p2">Tap to Play Audio</p>
          </div>
        ...
        <div class="flex flex-col gap-4 pt-8">
          ...
          >
            <p class="text-p3 text-sm font-semibold">Modes of getting to school</p>
            <div
          ...
          >
          <p class=" text-sm font-semibold">The capital of France is Paris</p>
          <div
        ...
        class="flex justify-between items-center bg-white dark:bg-color9 py-4 px-5 rounded-2xl"
      >
      <p class=" text-sm font-semibold">Gender Equality and Women's Rights</p>
      <div
        class="size-8 rounded-full text-white border border-color21 flex justify-center items-center"
      ></div>
    </div>
  ...
  >
  <p class="text-p1 text-sm font-semibold">Impact of Global Pandemics on Society</p>
  <div
