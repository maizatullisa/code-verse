  ...
  <body class="">
    ...
    >
      ...
      <div class="flex justify-start items-center gap-4 relative z-10">
        ...
        <h2 class="text-2xl font-semibold text-white">Verifikasi OTP</h2>
      </div>
      <!-- Page Title End -->
      ...
      <form action="#" class="relative z-10 otp-form">
        <div class="bg-white py-8 px-6 rounded-xl mt-12 dark:bg-color10">
          <div class="flex flex-col gap-3 text-center">
            <h3 class="text-xl font-semibold">Ketik Otp</h3>
            <p class="text-bgColor18 text-sm dark:text-color18">
              Masukkan kode verifikasi yang sudah dikirim ke
              <span class="text-p1">Email Anda</span>
            </p>
          </div>
