...
<!-- Mirrored from softivuslab.com/html/quizio/live-demo/create-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 05:04:43 GMT -->
<head>
    <meta charset="UTF-8" />
    ...
    <title>Create Password - Quizio PWA HTML Template</title>
  ...
  <body class="">
    ...
    >
      ...
      <div class="flex justify-start items-center gap-4 relative z-10">
        <h2 class="text-2xl font-semibold text-white">Create Password</h2>
      </div>
      <!-- Page Title End -->
      ...
      <form action="#" class="relative z-10">
        <div class="bg-white py-8 px-6 rounded-xl mt-12 dark:bg-color10">
          <div class="flex flex-col gap-3 text-center">
            <h3 class="text-xl font-semibold">Bikin Password</h3>
            <p class="text-bgColor18 text-sm dark:text-color18">
              Bikin Password Baru Untuk akun Anda Sekarang
            </p>
          </div>

          <div class="pt-4">
            <p class="text-sm font-semibold pb-2">Password Baru</p>
            <div
          ...
          <div class="pt-4">
            <p class="text-sm font-semibold pb-2">Konfirmasi Password Baru</p>
            <div
              class="flex justify-between items-center py-3 px-4 border border-color21 rounded-xl dark:border-color18 gap-3"
            >
              <input
