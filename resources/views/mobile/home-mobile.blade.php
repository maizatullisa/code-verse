...
<!-- Mirrored from softivuslab.com/html/quizio/live-demo/home.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 05:04:16 GMT -->
<head>
    <meta charset="UTF-8" />
      ...
      <div class="relative">
          ...
          >
            ...
            >
              ...
              <div
                class="flex flex-col justify-center items-center text-center gap-3 absolute left-[29%] bottom-0"
              >
                <img src="assets/images/icon1.png" alt="" class="" />
                <p class="text-xs font-semibold dark:text-white">Music Quiz</p>
              </div>
              <div
                class="flex flex-col justify-center items-center text-center gap-3 absolute left-[39.5%] -bottom-[3%]"
              >
                <img src="assets/images/icon3.png" alt="" class="" />
                <p class="text-xs font-semibold dark:text-white">Puzzle Quiz</p>
              </div>
              ...
              <div
                class="flex flex-col justify-center items-center text-center gap-3 absolute right-[31%] bottom-0"
              >
                <img src="assets/images/icon2.png" alt="" class="" />
                <p class="text-xs font-semibold dark:text-white">
                  Picture Quiz
    ...
    <div class="fixed bottom-0 left-0 right-0 z-40">
      ...
      >
        ...
        >
          ...
          >
            <i
              class="ph ph-squares-four text-xl !leading-none dark:text-white"
            ></i>
          </div>
