...
<!-- Mirrored from softivuslab.com/html/quizio/live-demo/request-withdrew.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 05:04:46 GMT -->
<head>
    <meta charset="UTF-8" />
    ...
    <title>Request Withdrew - Quizio PWA HTML Template</title>
      ...
      <div class="relative z-10 px-6">
        <div class="flex justify-between items-center gap-4">
          <div class="flex justify-start items-center gap-4">
            ...
            <h2 class="text-2xl font-semibold text-white">Request Withdrew</h2>
          </div>
        </div>
        <!-- Page Title End -->
        <div
        ...
        >
          <div class="flex justify-start items-start gap-3">
            ...
            <div class="text-white">
              <p class="text-2xl font-semibold">$60.00</p>
        ...
        <div
          class="px-5 py-7 mt-14 bg-p2 flex justify-between items-center rounded-2xl gap-3"
        >
          <div class="flex justify-start items-center gap-3">
            <div
              class="bg-white rounded-full flex justify-center items-center text-color9 text-xl !leading-none p-3"
            >
      ...
      <div class="hidden inset-0 z-50 withdrawModal">
        ...
        <div class="flex justify-end items-end flex-col h-full">
          <div class="container relative">
            ...
            />
            <div
              class="bg-white dark:bg-color1 relative z-40 overflow-auto pb-8"
            >
              ...
              <div class="px-6 pt-5">
                ...
                <div
                  class="py-3 px-4 bg-white rounded-xl border border-color21"
                >
                  <input
                    type="text"
                    placeholder="$50"
              ...
              <div class="px-6 pt-5">
                ...
                <div class="flex justify-start items-center gap-2">
                  ...
                  <div
                    class="py-2 px-4 rounded-xl text-sm bg-white border border-color21 text-color1"
                  >
                    $200
                  </div>
                  <div
                    class="py-2 px-4 rounded-xl bg-white text-sm border border-color21 text-color1"
                  >
                    $200
                  </div>
                </div>
...
<!-- Mirrored from softivuslab.com/html/quizio/live-demo/request-withdrew.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 05:04:47 GMT -->
</html>
