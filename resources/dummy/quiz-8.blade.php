...
<!-- Mirrored from softivuslab.com/html/quizio/live-demo/quiz-8.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 05:04:59 GMT -->
<head>
    <meta charset="UTF-8" />
    ...
    <title>Quiz 8 - Quizio PWA HTML Template</title>
      ...
      <div class="relative z-20 px-6">
        <div class="flex justify-between items-center gap-5">
          ...
          >
            ...
            <p class="text-xs font-semibold text-nowrap">8 of 10</p>
          </div>
        ...
        >
          ...
          <p class="text-2xl font-semibold pt-8">Question 08</p>
          <div class="pt-8">
            <img src="assets/images/quiz-8-img.png" alt="" class=" rounded-xl">
          </div>
        ...
        <div class="flex flex-col gap-4 pt-8">
          ...
          >
            <p class="text-p3 text-sm font-semibold">Book</p>
            <div
          ...
          >
          <p class=" text-sm font-semibold">Ruler</p>
          <div
        ...
        class="flex justify-between items-center bg-white dark:bg-color9 py-4 px-5 rounded-2xl"
      >
      <p class=" text-sm font-semibold">Pencil</p>
      <div
        class="size-8 rounded-full text-white border border-color21 flex justify-center items-center"
      ></div>
    </div>
  ...
  >
  <p class="text-p1 text-sm font-semibold">Sunglass</p>
  <div
