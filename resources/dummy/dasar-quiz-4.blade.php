...
<!-- Mirrored from softivuslab.com/html/quizio/live-demo/quiz-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jul 2025 05:04:45 GMT -->
<head>
    <meta charset="UTF-8" />
      ...
      <div class="relative z-20 px-6">
        <div class="flex justify-between items-center gap-5">
          ...
          >
            ...
            <p class="text-xs font-semibold text-nowrap">4 of 5</p>
          </div>
        ...
        >
          ...
          <p class="text-2xl font-semibold pt-8">Quiz 04</p>
        ...
        <div class="flex flex-col gap-4 pt-8">
          ...
          >
            <p class="text-p3 text-sm font-semibold">Linux</p>
            <div
        ...
        class="flex justify-between items-center bg-white dark:bg-color9 py-4 px-5 rounded-2xl"
      >
      <p class=" text-sm font-semibold"> Canva</p>
      <div
        class="size-8 rounded-full text-white border border-color21 flex justify-center items-center"
      ></div>
    </div>
  ...
  >
  <p class="text-p1 text-sm font-semibold">WhatsApp</p>
  <div
